...
| cpu-r7-7700 | 2399.00 | 1226.00 | 0.51 | 出带 review,用户 2026-09-14 人工批准接受京东【全新散片】行(沿用仅散片判例) |

review 3 条(870qvo 2tb 5.38、970evoplus 0.50、sn770 1.57)按 carry 处理
留待人工,详见 legacy-refresh-r2.jsonl。

## 处置(用户裁定,2026-09-14 会话)

- 仍挂 2026-07-28 的 52 个 SKU:候选池仅 20/115 规格齐全(memory 7/cooler 7/
  psu 4/case 2),与旧数据分布(ssd 10/case 8/gpu 8)品类错位,无法等价替换
  新型号 → 用户选择**全部剔除现价行**:SKU 保留在产品目录,仅无现价(推荐
  结果中报价缺失)。工具 collection-tools/2026-09-14/cull_stale_20260914.py,
  剔除 SKU 在 legacy-refresh-r2.jsonl 标 final=removed_20260914。
- cpu-r7-7700:review 出带(0.51),用户人工批准接受散片价 1226(旧行挂
  09-08 盒装 2399)。
- prices/2026-09-14.csv 最终 **108 行**:2026-09-08 86 行 / 2026-09-13 9 行 /
  2026-09-14 13 行;07-28 旧数据清零。导入仍用 `-snapshot-date 2026-09-14`。
