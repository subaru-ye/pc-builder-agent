# -*- coding: utf-8 -*-
"""2026-09-13 买手扩库批次:预算化 search/detail 驱动(checkpoint 幂等,可续跑)。
...
原始数据与 checkpoint 在 var/data/collections/2026-09-13-maishou-expansion-01/(不入库)。
"""
...
RAW = Path(
    os.environ.get(
        "COLLECTION_DATA_DIR",
        ROOT / "var/data/collections/2026-09-13-maishou-expansion-01",
    )
).resolve()
