...
function caseLabel(value: string) { return value === "gaming" ? "游戏" : value === "productivity" ? "生产力" : "通用"; }
function preferenceLabel(value: string) { return value === "silent" ? "安静" : value === "normal" ? "正常" : "不限"; }
